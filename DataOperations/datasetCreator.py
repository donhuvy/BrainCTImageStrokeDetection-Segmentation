...
class DataSetCreator:
    ...
    def insertImage(self, imagesPath, className):
        ...
        if number == 0:
            raise Exception(
                "This class doesn't exist. If you want to add this class to your dataset you can use addClass function.")
        else:
            print("here")
            for subdir, dirs, files in os.walk(imagesPath):
                ...
                for file in files:
                    ...
                    filestr2 = file
                    print("here")
                    if len(filestr.split(".")) == 2 and len(filestr2.split(" ")) == 1 and filestr.split(".")[1] in [
                        'png', 'jpg', 'jpeg']:
                    ...
                    counterin += 1
                    if len(filestr.split(".")) == 2 and len(filestr2.split(" ")) == 1 and filestr.split(".")[
                        1] == 'dcm':
                        print("burada")
